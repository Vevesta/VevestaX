...
setup(
    ...
    author='Vevesta Labs',
    license='Apache 2.0',
    install_requires=['pandas','Jinja2','ipynbname','datetime','openpyxl','xlrd','requests','matplotlib','pyspark','numpy','scipy','statistics', 'PyGithub','img2pdf','connectorx','jproperties'],
